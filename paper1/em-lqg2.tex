...
\usepackage[ngerman]{babel}  % Changed from 'german' to 'ngerman'
...
\title{\Huge\textbf{Das Auswahlproblem der Schleifenquantengravitation\\ 
		\Large - Umgangen durch Reverse-Simulation -}}
